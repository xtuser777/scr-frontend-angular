import { FreightOrder, IFreightOrder } from './freight-order.model';
import { IRepresentation, Representation } from './representation.model';
  ...
  constructor(attributes?: ILoadStep) {
    this.attributes = attributes
      ...
      : {
          ...
          load: 0.0,
          status: 0,
          freightOrder: new FreightOrder().toAttributes,
          representation: new Representation().toAttributes,
        };
  }
